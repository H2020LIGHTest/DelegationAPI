 ...
 * generated in the at.tugraz.iaik.java.lightest.experiment.xsd package. 
...
public class ObjectFactory {
	...
	private static final String XMSIG_NAMESPACE = "http://www.w3.org/2000/09/xmldsig#";
	
    private static final QName _SPKIData_QNAME = new QName(XMSIG_NAMESPACE, "SPKIData");
    private static final QName _KeyInfo_QNAME = new QName(XMSIG_NAMESPACE, "KeyInfo");
    private static final QName _SignatureValue_QNAME = new QName(XMSIG_NAMESPACE, "SignatureValue");
    private static final QName _KeyValue_QNAME = new QName(XMSIG_NAMESPACE, "KeyValue");
    private static final QName _Transforms_QNAME = new QName(XMSIG_NAMESPACE, "Transforms");
    private static final QName _DigestMethod_QNAME = new QName(XMSIG_NAMESPACE, "DigestMethod");
    private static final QName _X509Data_QNAME = new QName(XMSIG_NAMESPACE, "X509Data");
    private static final QName _SignatureProperty_QNAME = new QName(XMSIG_NAMESPACE, "SignatureProperty");
    private static final QName _KeyName_QNAME = new QName(XMSIG_NAMESPACE, "KeyName");
    private static final QName _RSAKeyValue_QNAME = new QName(XMSIG_NAMESPACE, "RSAKeyValue");
    private static final QName _Signature_QNAME = new QName(XMSIG_NAMESPACE, "Signature");
    private static final QName _MgmtData_QNAME = new QName(XMSIG_NAMESPACE, "MgmtData");
    private static final QName _SignatureMethod_QNAME = new QName(XMSIG_NAMESPACE, "SignatureMethod");
    private static final QName _Object_QNAME = new QName(XMSIG_NAMESPACE, "Object");
    private static final QName _SignatureProperties_QNAME = new QName(XMSIG_NAMESPACE, "SignatureProperties");
    private static final QName _Transform_QNAME = new QName(XMSIG_NAMESPACE, "Transform");
    private static final QName _PGPData_QNAME = new QName(XMSIG_NAMESPACE, "PGPData");
    private static final QName _Reference_QNAME = new QName(XMSIG_NAMESPACE, "Reference");
    private static final QName _RetrievalMethod_QNAME = new QName(XMSIG_NAMESPACE, "RetrievalMethod");
    private static final QName _DSAKeyValue_QNAME = new QName(XMSIG_NAMESPACE, "DSAKeyValue");
    private static final QName _DigestValue_QNAME = new QName(XMSIG_NAMESPACE, "DigestValue");
    private static final QName _CanonicalizationMethod_QNAME = new QName(XMSIG_NAMESPACE, "CanonicalizationMethod");
    private static final QName _Delegation_QNAME = new QName("", "delegation");
    private static final QName _SignedInfo_QNAME = new QName(XMSIG_NAMESPACE, "SignedInfo");
    private static final QName _Manifest_QNAME = new QName(XMSIG_NAMESPACE, "Manifest");
    private static final QName _SignatureMethodTypeHMACOutputLength_QNAME = new QName(XMSIG_NAMESPACE, "HMACOutputLength");
    private static final QName _TransformTypeXPath_QNAME = new QName(XMSIG_NAMESPACE, "XPath");
    private static final QName _SPKIDataTypeSPKISexp_QNAME = new QName(XMSIG_NAMESPACE, "SPKISexp");
    private static final QName _PGPDataTypePGPKeyID_QNAME = new QName(XMSIG_NAMESPACE, "PGPKeyID");
    private static final QName _PGPDataTypePGPKeyPacket_QNAME = new QName(XMSIG_NAMESPACE, "PGPKeyPacket");
    private static final QName _X509DataTypeX509IssuerSerial_QNAME = new QName(XMSIG_NAMESPACE, "X509IssuerSerial");
    private static final QName _X509DataTypeX509CRL_QNAME = new QName(XMSIG_NAMESPACE, "X509CRL");
    private static final QName _X509DataTypeX509SubjectName_QNAME = new QName(XMSIG_NAMESPACE, "X509SubjectName");
    private static final QName _X509DataTypeX509SKI_QNAME = new QName(XMSIG_NAMESPACE, "X509SKI");
    private static final QName _X509DataTypeX509Certificate_QNAME = new QName(XMSIG_NAMESPACE, "X509Certificate");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: at.tugraz.iaik.java.lightest.experiment.xsd
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DelegationType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "delegation")
    public JAXBElement<DelegationType> createDelegation(DelegationType value) {
        return new JAXBElement<DelegationType>(_Delegation_QNAME, DelegationType.class, null, value);
    }
